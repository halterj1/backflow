...
ActiveRecord::Schema.define(:version => 20130204075328) do
  ...
  add_index "reports", ["account_number"], :name => "index_reports_on_account_number", :unique => true
  ...
  add_index "taggings", ["report_id"], :name => "index_taggings_on_report_id"
